...
/**
 * Ecolingo marketing landing (LIGHT), served at `/`. Everything is scoped under the
...
const BENEFITS = [
  ...
  },
  {
    ...
    img: "/art-v2/eco-determined.webp",
    ...
    <div className={`${nunito.variable} landing`}>
      ...
      <header className="l-nav">
        <div className="l-container l-nav__inner">
          <Link href="/" className="l-wordmark" aria-label="Ecolingo home">
            <LeafMark />
            ecolingo
          </Link>
