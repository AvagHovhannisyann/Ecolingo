...
export const AI_TOOLS: AiTool[] = [
  ...
  },
  {
    ...
    status: "live",
    grounded: true,
    action: { kind: "route", href: "/teach/sources" },
  },
  {
    id: "accurate_graphs",
  ...
  },
  {
    ...
    status: "live",
    grounded: true,
    action: { kind: "generate", mode: "flashcards" },
  },
  {
    id: "rubric_builder",
    ...
    status: "live",
    grounded: true,
    action: { kind: "route", href: "/teach/rubric" },
  },
  {
    id: "lesson_plan",
    ...
    status: "live",
    grounded: true,
    action: { kind: "route", href: "/teach/plan" },
  },
  {
    id: "reading_level",
    ...
    status: "live",
    grounded: true,
    action: { kind: "route", href: "/teach/reading-level" },
  },
  {
    ...
    status: "live",
    grounded: true,
    action: { kind: "generate", mode: "misconceptions" },
  },
];
